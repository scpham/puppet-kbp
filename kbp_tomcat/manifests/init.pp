...
#  gen_puppet
#
define kbp_tomcat::apache_proxy_ajp_site($ensure="present", $port=8009, $ssl=false, $address=false, $redirect_non_ssl=true, $non_ssl=true, $serveralias=false, $documentroot="/srv/www/${name}", $tomcat_tag="tomcat_${environment}",
