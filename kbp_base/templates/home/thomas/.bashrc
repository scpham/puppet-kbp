...
#case "$TERM" in
#xterm-color)
#    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h.<%= environment %>\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
#    ;;
#*)
    PS1='${debian_chroot:+($debian_chroot)}\u@\h.<%= environment %>:\w\$ '
#    ;;
#esac
...
xterm*|rxvt*)
    ...
    PROMPT_COMMAND='echo -ne "\033]0;${HOSTNAME}.<%= environment %>: ${PWD/$HOME/~}\007"'
    ;;
*)
    ;;
esac
