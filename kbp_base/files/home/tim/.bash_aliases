alias kickpuppet='sudo puppet agent --no-daemonize --no-splay --onetime --usecacheonfailure false --ignorecache true --logdest console --logdest syslog --server puppetmaster.kumina.nl'
