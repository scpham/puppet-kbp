alias kickpuppet='sudo puppet agent --no-daemonize --no-splay --onetime --no-usecacheonfailure --ignorecache true --logdest console --logdest syslog --ca_server puppet.kumina.nl --ca_port 8141 '
